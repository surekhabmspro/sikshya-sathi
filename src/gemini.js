...
export const SIMULATION_TYPES = [
  ...
  { id: "memory", label: "जोडा मिलाउने कार्ड खेल", mechanic: "tap", instruction: "एउटा कार्ड पल्टाउने सम्झना/जोडा मिलाउने खेल (memory/flip-card matching) बनाउनुहोस् — कार्डहरू पल्टाएर सम्बन्धित जोडा (जस्तै शब्द र अर्थ, वा चित्र र नाम) फेला पार्नुपर्ने।" },
  ...
  { id: "crossword", label: "क्रसवर्ड पजल", mechanic: "type", instruction: "एउटा साधारण क्रसवर्ड (वाक्रम शब्द) पजल बनाउनुहोस् — पाठका शब्दावलीमा आधारित सङ्केत (clue) हेरेर ग्रिडको खानामा ट्याप/क्लिक गरी छानेपछि किबोर्डबाट अक्षर टाइप गरी शब्द भर्नुपर्ने।" },
...
function applySimulationSafetyNets(html) {
  ...
  //   quiet) instead of the earlier harsh sawtooth buzzer, plus a spoken
  //   "गलत!" a beat after.
  // - playCorrectSound: a warm 3-note ascending chime (triangle + a
  //   quiet sine layer underneath for roundness) plus a spoken "सही!".
  ...
  const engagementStyles = `<style>#ssComboWrap{position:fixed;top:10px;right:10px;display:flex;flex-direction:column;align-items:flex-end;gap:4px;z-index:2147483000;pointer-events:none}#ssComboBar{width:120px;height:8px;border-radius:999px;background:rgba(0,0,0,0.12);overflow:hidden}#ssComboFill{height:100%;width:0%;background:linear-gradient(90deg,#22C55E,#84CC16);transition:width .35s ease}#ssStreakBadge{display:none;align-items:center;gap:4px;background:#F59E0B;color:#fff;font-weight:700;font-size:13px;padding:2px 9px;border-radius:999px;box-shadow:0 2px 6px rgba(0,0,0,.25)}#ssLegend{position:fixed;bottom:10px;right:10px;display:flex;gap:10px;align-items:center;background:rgba(255,255,255,0.88);padding:5px 11px;border-radius:999px;box-shadow:0 2px 8px rgba(0,0,0,.15);font-size:13px;font-weight:600;z-index:2147483000;pointer-events:none;color:#1C1006}#ssIdleHint{position:fixed;left:50%;bottom:76px;transform:translateX(-50%) translateY(10px);background:rgba(28,16,6,0.85);color:#fff;font-size:14px;font-weight:600;padding:8px 16px;border-radius:999px;opacity:0;transition:opacity .35s ease, transform .35s ease;z-index:2147483000;pointer-events:none;white-space:nowrap}#ssIdleHint.ss-show{opacity:1;transform:translateX(-50%) translateY(0)}@keyframes ssShake{0%,100%{transform:translateX(0)}20%{transform:translateX(-6px)}40%{transform:translateX(6px)}60%{transform:translateX(-4px)}80%{transform:translateX(4px)}}body.ss-shake{animation:ssShake .35s ease}@media (max-width:480px){#ssComboBar{width:80px}#ssLegend{font-size:11px;padding:4px 8px}}</style>`;
